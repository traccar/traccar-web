...
import { Grid, Paper, makeStyles, FormControl, InputLabel, Select, MenuItem, Button, TextField } from '@material-ui/core';
...
const ReportParameters = (props) => {
  ...
  const handleShow = () => {
    ...
    props.handleShow(deviceId, selectedFrom, selectedTo);
