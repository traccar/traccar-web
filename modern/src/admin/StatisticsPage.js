...
import { FormControl, InputLabel, Select, MenuItem, Button, TextField, TableContainer, Table, TableRow, TableCell, TableHead, TableBody, Paper } from '@material-ui/core';
...
const Filter = ({ setItems }) => {
  ...
  return (
    <>
      ...
      <Button color="primary" variant="outlined" onClick={handleClick} fullWidth>{t('reportShow')}</Button>
    </>
  );
}
