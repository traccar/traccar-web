...
const MapGeofenceEdit = ({ selectedGeofenceId }) => {
      ...
      new MapboxDraw({
        ...
        styles: [
...

          {
            ...
            paint: {
              'fill-color': ['coalesce', ['get', 'user_color'], '#2196f3'],
              'fill-opacity': 0.2,
            },
          },
          ...
          // polygon border
          {
            ...
            filter: ['all', ['==', '$type', 'Polygon']],
            paint: {
              'line-color': ['coalesce', ['get', 'user_color'], '#2196f3'],
              'line-width': 2,
            },
          },

          {
            id: 'gl-draw-line-custom',
            type: 'line',
  ...
  useEffect(() => {
    ...
    Object.values(geofences).forEach((geofence) => {
      ...
      const color = geofence.attributes?.color || geofence.color || '#2196f3';
